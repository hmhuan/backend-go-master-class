...
// Source: github.com/hmhuan/backend-go-master-class/db/sqlc (interfaces: Store)
...
// GetTransfersBetweenAccounts mocks base method.
func (m *MockStore) GetTransfersBetweenAccounts(arg0 context.Context, arg1 db.GetTransfersBetweenAccountsParams) ([]db.Transfer, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransfersBetweenAccounts", arg0, arg1)
	ret0, _ := ret[0].([]db.Transfer)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetTransfersBetweenAccounts indicates an expected call of GetTransfersBetweenAccounts.
func (mr *MockStoreMockRecorder) GetTransfersBetweenAccounts(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTransfersBetweenAccounts", reflect.TypeOf((*MockStore)(nil).GetTransfersBetweenAccounts), arg0, arg1)
}
